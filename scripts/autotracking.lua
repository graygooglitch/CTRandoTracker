...
KEY_ITEMS = {
  ...
  {value=0xD9, name="ctrigger",type="progressive",stage=1},
  ...
  {value=0xE2, name="ctrigger",type="progressive",stage=2},
...
function updateEventsAndBosses(segment) 
  ...
  if not itemsOnlyTracking() then
    ...
    -- Dark Ages
		...
		updateEvent("@Medina Elder's House/Counter Sparkle", segment, 0x7F01A4, 0x04)
		updateEvent("@Medina Elder's House/Upstairs Sparkle", segment, 0x7F01A4, 0x02)
